...
describe('canonical post hashtag migration', () => {
  it('repairs a database that already recorded the reverted v31 hashtag migration', () => {
    ...
    client.exec(`
      ...
      VALUES (31, 'page_wall_separate_hashtags', 1);
    `)
    ...
    ).get(CANONICAL_POST_HASHTAG_SCHEMA_VERSION)).toEqual({
