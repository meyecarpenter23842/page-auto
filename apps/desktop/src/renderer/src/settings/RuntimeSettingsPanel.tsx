...
export function RuntimeSettingsPanel() {
  ...
  return <div className="settings-section runtime-settings-section">
    ...
    <div className="runtime-settings-grid">
      ...
      <label className="number-field"><span>Delay mở Chrome giữa Page Tab</span><div><input type="number" min="0" max="120" step="1" value={draft.browserLaunchSpacingMs / 1000} onChange={(event) => update('browserLaunchSpacingMs', Math.round(Number(event.target.value) * 1000))} /><em>giây</em></div></label>
